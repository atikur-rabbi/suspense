...
// Function to display track name
  ...
  var order = shuffle(osts.concat(openings).concat(endings));  // shuffle for random
//	var order = (osts.concat(openings).concat(endings));      // rearrange all
//	var order = (openings);      // only one type
